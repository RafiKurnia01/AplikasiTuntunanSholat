...
import com.azhar.bacaansholat.adapter.AyatPendekAdapter
import com.azhar.bacaansholat.model.ModelBacaan
import kotlinx.android.synthetic.main.activity_ayat_kursi.toolbar
import kotlinx.android.synthetic.main.activity_ayat_pendek.rvAyatPendek
import org.json.JSONArray
import org.json.JSONException
import java.io.IOException
import java.nio.charset.StandardCharsets

class AyatPendekActivity : AppCompatActivity() {

    var ayatPendekAdapter: AyatPendekAdapter? = null
    var modelBacaan: MutableList<ModelBacaan> = ArrayList()


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ayat_pendek)
        ...
        ayatPendekAdapter = AyatPendekAdapter(modelBacaan)

        rvAyatPendek.setLayoutManager(LinearLayoutManager(this))
        rvAyatPendek.setHasFixedSize(true)
        rvAyatPendek.setAdapter(ayatPendekAdapter)

        getDataAyatPendek()
    }

    private fun getDataAyatPendek(){
        try{
            ...
            try{
                ...
                ayatPendekAdapter?.notifyDataSetChanged()
